      ...
      <div className="p-4 relative">
        ...
        <div className="mt-16 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {branches.map((branch) => (
            <div
              key={branch.id}
              className="bg-white rounded-xl shadow-md hover:shadow-xl transition-shadow duration-300 dark:bg-gray-800 border dark:border-gray-700"
            >
              {branch.imageUrl && (
                ...
                <img
                  ...
                  className="w-full h-48 object-cover mb-4 rounded-tr-xl rounded-tl-xl"
                />
              )}
              <div className="flex flex-col px-3">
                ...
                <div className="space-y-1">
                  <p className="text-gray-700 dark:text-zinc-100 text-base">
              ...
              <div className="mt-4 space-x-3 m-3">
                <button
